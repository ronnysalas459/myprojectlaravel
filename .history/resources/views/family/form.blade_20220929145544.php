...
@section('content')
    <div class="container py-5">
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" class="form-control" name="age" id="age" placeholder="Enter age" value = "{{old('age')}}">
            @error('age')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-group mb-3">
            ...
            <select class="form-control" name="is_alive" id="is_alive" value = "{{old('is_alive')}}">
